const paper = {
  install (Vue, options) {
    ...
    var requester = require('./requester.js')(options.store, options.router, options.axios, error)
    var demo = require('./demo.js')(options.store, requester, parser)
    var page = require('./page.js')(options.store, options.router, requester, parser)
